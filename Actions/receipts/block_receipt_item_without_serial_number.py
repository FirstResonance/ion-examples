...
input = {
  ...
  "if not context.get('receiptItem', {}).get('partInventory', {}).get('serialNumber') and context.get('receiptItem', {}).get('partInventory', {}).get('part', {}).get('trackingType') == 'SERIAL': raise ValidationError()"
}
